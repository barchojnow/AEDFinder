...
// Pure math helpers shared by the view, the tile client and the AED
// menu. No UI or network dependencies, so everything here is trivially
// unit-testable and reusable.
//
// Carried over unchanged from ZabkaFinder: Haversine distance and
// initial bearing don't care what they are pointing at, and the code
// already had independently computed reference values behind it.
module GeoMath {
